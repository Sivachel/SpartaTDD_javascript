...
//Allows user to subtract 2 numbers
  if (op == "-")
  {
    alert (subtractTwoNumbers());
  }
//Allows user multiply 2 numbers
  if (op == "*")
  {
    alert(multiplyTwoNumbers());
  }
// Allows user to divide 2 numbers
  if (op == "/")
  {
    alert(divideTwoNumbers());
  }
}
...
function Trip_calculator() {
  ...
  if (num4 > 60){
    alert(("It will take you ") + (highSpeedMileagetime()) + " hours and it will cost you £ " + (highSpeedMileagecost()));
  }
  else {
    alert(("It will take you ") + (normalMileageTime()) + " hours and it will cost you £ " + (normalMileageCost()));
  }
}
